...
@section('content')
    <x-container>
        <div class="col-12 col-lg-8">
            <x-card title="DAFTAR PERMINTAAN BARANG YANG BELUM ADA DI GUDANG" class="card-body p-0">
                <x-table>
                    <thead>
                        <tr>
                            <th>#</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($order->status == App\Enums\OrderStatus::Success)
                                        @php
                                            $product = $productsMap[$order->name] ?? null;
                                        @endphp
                                        @if($product)
                                        ...
                                        @else
                                            <button type="button" class="btn btn-secondary btn-sm" disabled>Produk belum terdaftar</button>
                                        @endif
                                    @endif
                                </td>
                            </tr>
